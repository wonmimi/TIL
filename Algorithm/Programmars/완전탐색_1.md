## 완전탐색 - [모의고사](https://programmers.co.kr/learn/courses/30/lessons/42840?language=java) 문제 
...
- 자바 자료구조 개념 탄탄하게 
- 컬렉션 프레임워크 내장함수 익숙해지도록 익히기
- List 는 선언할때 갯수 지정 안해도된다 - 효율 
- [도움](https://blog.naver.com/PostView.nhn?blogId=yongyos&logNo=221486300664)